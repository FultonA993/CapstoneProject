...
class MyApplication(QtWidgets.QMainWindow):
    ...
    def open_program1(self):
        ...
        program_path = "/Capstone/hello_flask/hello_flask/directory.py"
    ...
    def open_program2(self):
        # Define the path to the program to run
        program_path2 = "/Capstone/hello_flask/hello_flask/payroll.py"
        # Run the program using subprocess
    ...
    def open_program3(self):
        # Define the path to the program to run
        program_path3 = "/Capstone/hello_flask/hello_flask/infoPage.py"
        # Run the program using subprocess
    ...
    def open_program4(self):
        # Define the path to the program to run
        program_path4 = "/Capstone/hello_flask/hello_flask/morePage.py"
        # Run the program using subprocess
    ...
    def open_program5(self):
        # Define the path to the program to run
        program_path5 = "/Capstone/hello_flask/hello_flask/testBlacklist.py"
        # Run the program using subprocess
    ...
    def open_program6(self):
        # Define the path to the program to run
        program_path6 = "/Capstone/hello_flask/hello_flask/testLicenses.py"
        # Run the program using subprocess
    ...
    def open_program7(self):
        # Define the path to the program to run
        program_path7 = "/Capstone/hello_flask/hello_flask/complaint.py"
        # Run the program using subprocess
    ...
    def quit_app(self):
        # Define the path to the program to run
        program_path7 = "/Capstone/hello_flask/hello_flask/main.py"
        # Run the program using subprocess
        subprocess.Popen([sys.executable, program_path7])
        self.app.quit()
